      ...
      if (($this->pages) > 1)
      {
        ...
        if ($this->page != 1) {
          if ($this->showFirstAndLast) {
            $plinks[] = ' <a href="?page=1'.$queryURL.'">&laquo;&laquo; Primera </a> ';
          }
        ...
        for ($j = 1; $j < ($this->pages + 1); $j++) {
          if ($this->page == $j) {
            $links[] = ' <span class="current">'.$j.'</span> '; // If we are on the same page as the current item
          } else {
        ...
        if ($this->page < $this->pages) {
          $slinks[] = ' <a href="?page='.($this->page + 1).$queryURL.'"> Sig &raquo; </a> ';
          if ($this->showFirstAndLast) {
            $slinks[] = ' <a href="?page='.($this->pages).$queryURL.'"> &Uacute;lt &raquo;&raquo; </a> ';
          }
        }
